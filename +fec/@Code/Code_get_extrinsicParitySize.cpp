...
{
  if (nrhs != inputCount) {
    throw std::invalid_argument("Wrong argin count in Code_get_extrinsicParitySize");
  }
  if (nlhs != outputCount) {
    throw std::invalid_argument("Wrong argout count in Code_get_extrinsicParitySize");
  }
