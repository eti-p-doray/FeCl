...
%This function shows how to construct a turbo code.
    ...
    code = fec.TurboCode({trellis, trellis}, {pi1, pi2});
    
    %The code is generalized to any number of constituents.
    code = fec.TurboCode({trellis, trellis, trellis}, {pi1, pi2, randperm(200)});
    
    %We can specify the number of iteration for decoding. default = 5
    code = fec.TurboCode({trellis, trellis}, {pi1, pi2}, 5);
    ...
    code = fec.TurboCode({trellis, trellis}, {pi1, pi2}, 5, fec.StructureType.Parallel, fec.MapType.LogMap)
    ...
    code = fec.TurboCode({trellis, trellis}, {pi1, pi2}, 5, fec.StructureType.Parallel, fec.MapType.LogMap, 2)
