...
#include "ErrorCorrectingCode/TurboCode/TurboCode.h"
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )
{
  ...
  TrellisStructure trellis1 = toTrellisStructure(prhs[0], prhs[1], prhs[2], prhs[3], prhs[4]);
  TrellisStructure trellis2 = toTrellisStructure(prhs[5], prhs[6], prhs[7], prhs[8], prhs[9]);
  TurboCodeStructure codeStructure(trellis1, trellis2, toInterleaver(prhs[10]), toScalar<size_t>(prhs[11]), toEnum<ConvolutionalCodeStructure::BlocEndType>(prhs[12], BlocEndTypeEnumeration, BlocEndTypeCount), toEnum<ConvolutionalCodeStructure::DecoderType>(prhs[13], MapTypeEnumeration, MapTypeCount));
  std::unique_ptr<ErrorCorrectingCode> code = ErrorCorrectingCode::create(codeStructure, toScalar<size_t>(prhs[14]));
