 ...
 *  \since 2015-06-14
 *  \version Last update : 2015-06-14
 *
...
{
  if (nrhs != inputCount) {
    throw std::invalid_argument("Wrong argin count in ErrorCorrectingCode_get_extrinsicSize");
  }
  if (nlhs != outputCount) {
    throw std::invalid_argument("Wrong argout count in ErrorCorrectingCode_get_extrinsicSize");
  }
