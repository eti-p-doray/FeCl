...
namespace fec {
  ...
  public:
     ...
     */
    class Structure : public Ldpc::Structure {
      friend class ::boost::serialization::access;
    public:
      Structure() = default;
    ...
    private:
      ...
      void serialize(Archive & ar, const unsigned int version) {
        ...
        ar & ::BOOST_SERIALIZATION_BASE_OBJECT_NVP(Ldpc::Structure);
    ...
    PuncturedLdpc(const Structure& structure, int workGroupSize = 8);
    ...
    PuncturedLdpc& operator=(const PuncturedLdpc& other) {Codec::operator=(other); structure_ = std::unique_ptr<Structure>(new Structure(other.structure())); return *this;}
...
BOOST_CLASS_EXPORT_KEY(fec::PuncturedLdpc::Structure);
BOOST_CLASS_TYPE_INFO(fec::PuncturedLdpc::Structure,extended_type_info_no_rtti<fec::PuncturedLdpc::Structure>);
